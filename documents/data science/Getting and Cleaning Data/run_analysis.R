...
# notes: web address is -- https://d396qusza40orc.cloudfront.net/getdata%2Fprojectfiles%2FUCI%20HAR%20Dataset.zip 
# I unzipped the files in windows. I tried to do this as part of this script but 
# I could not get it to work. The command I tried was unzip("C:/Users/Owner/Documents/Data Science/data/getdata_projectfiles_UCI_HAR_dataset")
...
write.table(dt3, file = "C:/Users/OWner/Documents/tidydata.csv")
